...
var animalSound = (name, sound, callback) => "I am " + name + ". Hear me woof.";
...
var shortNames = friends.filter((element) => element.length<4);
...
goodPeople.forEach((val,i,arr)=> family: true)